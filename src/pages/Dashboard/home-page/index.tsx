      ...
      <div className="h-full w-full max-w-[1500px] p-2 lg:p-5">
        <div className="flex flex-col gap-6">
          <div className="grid md:grid-cols-2 xl:grid-cols-3 gap-6">
            <div className="relative flex flex-col items-center justify-center rounded-lg border p-6 md:p-8 w-full overflow-hidden">
              <Image
                src="/assets/dashboard/lotus.jpg"
                alt="lotus"
                height={300}
                width={300}
              ...
              <div className="z-10">
                ...
                <div className="flex flex-col mt-6 bg-[#f8f8f7] p-4 rounded-lg w-full">
            ...
            <div className="relative flex flex-col items-center justify-between rounded-lg border p-6 md:p-8 overflow-hidden w-full">
              <h1 className="self-start font-bold text-lg">Network Info</h1>
              <div className="bg-[#f8f8f7] p-6 rounded-lg mt-6 w-full">
                <div className="flex flex-col w-full gap-5 text-nowrap">
                  <div className="grid grid-cols-3">
                    <div>
                      <div className="text-gray-500 text-sm">Token Price</div>
                      <div className="text-lg font-bold">$216.37</div>
                    </div>
                    <div>
                      <div className="text-gray-500 text-sm">Daily Volume</div>
                      <div className="text-lg font-bold">$11.7B</div>
                    </div>
                    <div>
                      <div className="text-gray-500 text-sm">SOL Staked</div>
                      <div className="text-lg font-bold">65.56%</div>
                    </div>
                  </div>
                  <div className="grid grid-cols-3">
                    <div>
                      <div className="text-gray-500 text-sm">Transactions</div>
                      <div className="text-lg font-bold">340.2B</div>
                    </div>
                    <div>
                      <div className="text-gray-500 text-sm">Avg TPS</div>
                      <div className="text-lg font-bold">4,308</div>
                    </div>
                    <div>
                      <div className="text-gray-500 text-sm">Epoch</div>
                      <div className="text-lg font-bold">701</div>
                    </div>
                  </div>
                  <div>
                    <div className="text-gray-500 text-sm">Epoch Progress</div>
              ...
              <Link
                href="#"
                target="_blank"
                className="text-gray-400 text-xs self-end mt-2"
              >
                View More
              </Link>
            </div>
            <div className="hidden xl:flex">
              <div className="bg-marble p-6 xl:p-8 rounded-lg w-full flex justify-center flex-col items-center bg-cover">
                <h1 className="font-bold text-3xl lg:text-4xl">
                  God Node is now available!
                </h1>
                <div className="mt-4 xl:mt-6">
                  <p className="text-pretty lg:text-lg">
                    Get your trading to the next level with God Node.
                    <br />
                    <br />
                    Unlimited Requests.
                    <br />
          ...
          <div className="rounded-lg border p-6 md:p-8 w-full overflow-hidden">
            <h1 className="font-bold text-lg">Jito Tips Tracker</h1>
            <div className="text-gray-500 text-md">
              Track the latest landing Jito Tips. Don&apos;t waste your money with
              overpriced tips.
            </div>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mt-6">
              <div className="bg-[#f8f8f7] rounded-xl p-4 flex flex-col gap-2">
                ...
                <div className="text-gray-500 text-xl mt-4 mb-2 self-center">
                  0.000021 SOL
                </div>
              </div>
              <div className="bg-[#f8f8f7] rounded-xl p-4 flex flex-col gap-2">
          ...
          <div className="w-full rounded-lg border p-6 md:p-8">
            <h1 className="self-start font-bold text-lg">Your Nodes</h1>
            <div className="text-gray-500 text-md">
            ...
            <div className="h-full w-full flex flex-col justify-center items-center text-center border-2 border-dashed py-28 rounded-lg mt-6">
              ...
              <div className="flex gap-x-4 my-4">
                ...
                <Link href="#">
                  <button className="flex justify-center items-center font-semibold gap-2.5 text-sm px-5 py-2 rounded-md hover:scale-[1.01] transition-all duration-200 transform-gpu border text-black">
                    Use Free Node
                  </button>
                </Link>
              </div>
