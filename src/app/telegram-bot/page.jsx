...
export const metadata = {
  ...
  description: "Take your crypto trading to the next level with the Leap Telegram Bot.Real-time trade updates, coin analytics, limit orders, DCA orders, and copy trading.",
