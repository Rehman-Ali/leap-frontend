...
const HeroSection = () => {
  ...
  return (
    ...
    >
      {/* Background Image */}
      <div className="absolute inset-0 bg-[url('/assets/home/hero-section/bg.png')] bg-cover bg-center -z-10" />
      ...
      <div className="relative flex flex-col h-full z-10 mx-[10px]">
        <div className="flex flex-col justify-center items-center px-8 space-y-4">
          ...
          <p
            className={`text-[#C6C7C6] text-[16px] ${animationTriggered
              ? "animate-slideIn"
        ...
        <div className="flex flex-wrap mt-[30px] gap-[24px] justify-center">
          {[
            ...
            <div
              key={index}
              className={`flex ${animationTriggered
                ? "animate-slideInFade"
                : ""}   flex-col w-[23%] mw-8:w-[97%] mw-12:w-[48%] bg-[#131412] rounded-[12px] p-[24px] max-h-[300px] h-auto`}
              style={{
