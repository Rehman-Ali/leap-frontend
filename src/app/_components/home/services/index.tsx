  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col  mw-8:items-start mw-8:flex-col mw-8:space-y-6 md:flex-row justify-between items-center mt-[30px] space-y-0">
        {/* Left Content */}
        <div className={`flex flex-col  items-start ${animationTriggered ? "animate-slideIn" : ""
          }`}>
          ...
          <p className={`text-white ${animationTriggered ? "animate-slideIn" : ""
          ...
          <p className={`text-[#C5C6C5] ${animationTriggered ? "animate-slideIn" : ""
          ...
          {[
            ...
            <div key={index} className={`flex flex-row items-center ${animationTriggered ? "animate-slideIn" : ""
              } gap-x-2 mb-[10px]`}>
          ...
          <button className={`w-[168px] ${animationTriggered ? "animate-slideIn" : ""
        ...
        {/* Right Content */}
        <div className={`flex justify-center   mw-8:w-[100%] ${animationTriggered ? "animate__animated animate__fadeInRight" : ""} `}>
          <Image
